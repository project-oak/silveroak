...
(*          Let (App (Primitive (Fst _ _)) (Var a_binder)) *)
(*            (fun a : var Unit (primitive_output (Fst _ _)) => *)
(*             Let (App (Primitive (Snd _ _)) (Var a_binder)) *)
(*               (fun b => *)
(*                Let (Var s2) *)
(*                  (fun *)
(*                     a_binder0 => *)
...
(*                     (App *)
(*                        (Primitive *)
(*                           (Fst (primitive_output (Fst _ _)) *)
(*                              (primitive_output (Snd _ _)))) *)
(*                        (Var a_binder0)) *)
(*                     (fun _ => *)
(*                      Let *)
(*                        (App *)
...
(*                        (fun _ *)
(*                           (1* _ : var Unit *1) *)
(*                           (1*       (primitive_output *1) *)
(*                           (1*          (Snd (primitive_output (Fst Bit Bit)) *1) *)
(*                           (1*             (primitive_output (Snd Bit Bit)))) *1) *)
(*                                       => *)
(*                         (1* App *1) *)
(*                         (1*   (App (App (mux_item var) (Var a)) *1) *)
(*                         (1*      (tupleHelper (Var a) (Var b))) *1) *)
(*                           (Var s1) *)
