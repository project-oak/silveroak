...
Section sanity_check.
  ...
  Lemma aes_mul_gf2p2_wf: wf_debrujin [] (Desugar (@aes_mul_gf2p2) _).
  Proof. wf_kappa_via_compute. Qed.

  Lemma aes_mul_gf2p4_wf: wf_debrujin [] (Desugar (@aes_mul_gf2p4) _).
  Proof. wf_kappa_via_compute. Qed.

  Lemma aes_square_scale_gf2p4_gf2p2_wf: wf_debrujin [] (Desugar (@aes_square_scale_gf2p4_gf2p2) _).
  Proof. wf_kappa_via_compute. Qed.
