...
cp $BEDROCK2_EXPERIMENTS/uart.c.out sw/device/silicon_creator/lib/drivers/uart.c
...
build/lowrisc_systems_chip_earlgrey_verilator_0.1/sim-verilator/Vchip_earlgrey_verilator \
    ...
    --meminit=flash,build-bin/sw/device/silicon_creator/testing/sw_silicon_creator_lib_driver_uart_functest_sim_verilator.elf
